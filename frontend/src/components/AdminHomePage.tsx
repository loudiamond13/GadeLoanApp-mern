        ...
        <div className="col-md-6 mb-4">
          <div className="card h-100 rounded-3 shadow">
            <div className="card-body">
              ...
              <p className="card-text">Add Employee, Lock/Unlock, or delete user accounts.</p>
              <Link to="/users" className="btn btn-primary d-block">Manage Users</Link>
            </div>
          </div>
        </div>
        <div className="col-md-6 mb-4">
          <div className="card h-100 rounded-3 shadow">
            <div className="card-body">
              ...
              <Link to="/loan-requests" className="btn btn-primary d-block">Manage Loan Requests</Link>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="col-md-6 mb-4">
          <div className="card h-100 rounded-3 shadow">
            <div className="card-body">
              ...
              <p className="card-text">Update your admin profile information.</p>
